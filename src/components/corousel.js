      ...
      <div className="carousel-inner">
        <div className="carousel-item item-1 active">
          <div className="carousel-caption mb-5 text-right">
            <h1 className="display-3 text-capitalize mb-2 text-light">Developers</h1>
            <a href="#myportfolio" className="btn btn-lg mb-5 text-uppercase banner-btn">Our work</a>
          </div>
        </div>
        <div className="carousel-item item-2">
          <div className="carousel-caption mb-5 text-center">
            <h1 className="display-3 text-capitalize mb-2 text-light">Designers</h1>
            <a href="#myportfolio" className="btn btn-lg mb-5 text-uppercase banner-btn">Our work</a>
          </div>
        </div>
        <div className="carousel-item item-3">
          <div className="carousel-caption mb-5 text-center">
            <h1 className="display-3 text-capitalize mb-2 text-light">Engineers</h1>
            <a href="#myportfolio" className="btn btn-lg mb-5 text-uppercase banner-btn">Our work</a>
          </div>
        </div>
